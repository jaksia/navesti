import { colors, blinking, textColors } from './consts/styles';
...
type Letter =
	...
	| 'Y'
	| 'Z';
type InvertedLetter = `${Letter}_`;

export type CustomLightSymbol = Letter | InvertedLetter | 'short_distance' | 'disabled';
...
export const textColorClasses = {
	[CustomLightColor.BLUE]: textColors.blue,
	[CustomLightColor.RED]: textColors.red,
	[CustomLightColor.GREEN]: textColors.green,
	[CustomLightColor.YELLOW]: textColors.yellow,
	[CustomLightColor.WHITE]: textColors.white
};
